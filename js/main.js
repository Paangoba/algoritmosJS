...
function operacinesB() {
  ...
  alert("la suna es igual a : " + suma);
  alert("la resta es igual a : " + resta);
  alert("La multiplicación es igual a : " + multiplication);
...
function inversion() {
  ...
  function notas(){
    ...
    alert("El estudiante: " + " " + nombreestudiante+ "En la asignatura: " +" "+Asignatura+ "Tiene un promedio de: "+" "
    +promedio.toFixed(1)+ " Con estado: "+" "+ mensajefinal);
...
function kilos(){
  ...
  alert("La cantidad de manzanas: " +cantidad+ "El precio por la compra es:"+precio+ "El descuento aplicado es: "
  +(descuento*100) +"%"+ "El precio con descuento es: $" + precioDes.toFixed(2));
  }
